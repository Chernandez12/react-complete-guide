  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <button style={style}onClick={() => this.switchNameHandler('ANDRE!!')}>Switch Name</button>
        <Person 
        ...
        <Person 
          ...
          click={this.switchNameHandler.bind(this, 'Dre!!')}
          changed={this.nameChangedHandler}>I like Andre</Person>
        <Person 
